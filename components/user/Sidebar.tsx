...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      <div
        className={`md:left-0 z-20 static ${pathname === "/user/dashboard" ? "dash" : "not-dash"}  ${showSidebar ? "block w-0 " : "hidden lg:block "
          }   h-screen  `}
      >
        <div className="h-screen fixed ">
          <div
            className={`h-screen sidebar-scroll  flex-row flex-nowrap  main-bg sidebar-width z-10 text-white   transition-all duration-300`}
          >
            <div className="flex-col items-stretch min-h-full flex-nowrap px-0 mb-12 ">
              ...
              <div className="flex flex-col">
                ...
                <ul className="flex-col min-w-full flex list-none px-6">
                  ...
                  <li
                    className={`${pathname === "/user/payment/history" &&
                      "bg-gradient-to-tr from-light-blue-500 to-light-blue-700 text-white shadow-md"
                      } rounded-md mb-2  hover:bg-red-500 transition-colors text-white ease-linear duration-500`}
                  >
                    <Link
                  ...
                  <li
                    ...
                    rounded-md mb-2  hover:bg-red-500 transition-colors ease-linear duration-500"
                  >
                    <Link
                      className="flex items-center hover:text-white gap-4 text-sm text-white font-light px-4 py-2 rounded-md"
                      href="#"
