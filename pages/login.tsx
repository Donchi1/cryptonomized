...
const Login = () => {
  ...
  return (
    <div className="min-h-screen footer-bg  homepage-3  flex justify-center">
      <div className="   shadow sm:rounded-lg flex justify-center flex-1 items-center ">
        <div className="lg:w-1/3 xl:w-5/12 w-full px-6 sm:p-10  ">
          <div className="  flex flex-col items-center main-bg p-6 rounded-lg">
            ...
            <form className="w-full flex-1 mt-8  " onSubmit={formik.handleSubmit}>
              <div className="mx-auto max-w-lg  relative space-y-4 ">
                <div className=''>
                ...
                <button
                  ...
                  type="submit"
                  className="mt-4 tracking-wide font-semibold btn_one text-gray-100 w-full py-3 rounded-lg  transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none"
                >
                ...
                <div className="mx-auto mx-w-sm w-full">
                  <Link
                    className="mt-5  tracking-wide  hover:text-white font-semibold border border-[#ffc400] text-gray-100 w-full py-3 rounded-lg  transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none"
                    href="/register"
                  >
                  ...
                  <Link
                    className="mt-4 tracking-wide   font-semibold btn_two text-gray-100 w-full py-3 rounded-lg  transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none"
                    href="/reset"
                  >
